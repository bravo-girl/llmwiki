...
- Quellen-ID: `https://www.dbinfrago.com/resource/blob/13705102/86e9b1111e362325368fc8aef3e21e67/Anlage-2-Technische-Funktionsbeschreibung-data.pdf`
- Original-URL: [PDF beim Herausgeber öffnen](https://www.dbinfrago.com/resource/blob/13705102/86e9b1111e362325368fc8aef3e21e67/Anlage-2-Technische-Funktionsbeschreibung-data.pdf)
- Quellen-Schlüssel: `src-3c1dbf36cdb698c2df41`
- Abrufdatum: 2026-06-27
- Original: [[anlage-2-technische-funktionsbeschreibung--src-3c1dbf36cdb698c2df41.pdf]]
...
Anlage 2: Technische Funktionsbeschreibung EVU-Schnittstelle Bestellsystem („pathOS“), Version 4.6.3 2
...
4.6.2 Keine Anpassungen 11.09.2025
4.6.3 DB InfraGO AG Keine Anpassungen 18.12.2025
Fabian Sommer
Anlage 2: Technische Funktionsbeschreibung EVU-Schnittstelle Bestellsystem („pathOS“), Version 4.6.3 3
...
Anlage 2: Technische Funktionsbeschreibung EVU-Schnittstelle Bestellsystem („pathOS“), Version 4.6.3 4
...
Rede.
Anlage 2: Technische Funktionsbeschreibung EVU-Schnittstelle Bestellsystem („pathOS“), Version 4.6.3 5
...
 ObjectInfoMessage
 UpdateLinkMessage
Anlage 2: Technische Funktionsbeschreibung EVU-Schnittstelle Bestellsystem („pathOS“), Version 4.6.3 6
...
Anlage 2: Technische Funktionsbeschreibung EVU-Schnittstelle Bestellsystem („pathOS“), Version 4.6.3 7
...
Anlage 2: Technische Funktionsbeschreibung EVU-Schnittstelle Bestellsystem („pathOS“), Version 4.6.3 8
...
Anlage 2: Technische Funktionsbeschreibung EVU-Schnittstelle Bestellsystem („pathOS“), Version 4.6.3 9
...
Geschäftsvorfall.
Anlage 2: Technische Funktionsbeschreibung EVU-Schnittstelle Bestellsystem („pathOS“), Version 4.6.3 10
...
Anlage 2: Technische Funktionsbeschreibung EVU-Schnittstelle Bestellsystem („pathOS“), Version 4.6.3 11
...
Anlage 2: Technische Funktionsbeschreibung EVU-Schnittstelle Bestellsystem („pathOS“), Version 4.6.3 12
...
Anlage 2: Technische Funktionsbeschreibung EVU-Schnittstelle Bestellsystem („pathOS“), Version 4.6.3 13
...
Anlage 2: Technische Funktionsbeschreibung EVU-Schnittstelle Bestellsystem („pathOS“), Version 4.6.3 14
...
Anlage 2: Technische Funktionsbeschreibung EVU-Schnittstelle Bestellsystem („pathOS“), Version 4.6.3 15
...
Anlage 2: Technische Funktionsbeschreibung EVU-Schnittstelle Bestellsystem („pathOS“), Version 4.6.3 16
